...
showInstruction (Cond c1 c2)	  = iConcat [iStr "Cond [", iIndent (iConcat [iStr "2: ", iShortCode 3 c1, iNewline,
...
showInstruction (Casejump xs)     = iConcat [iStr "Casejump ",  iIndent (iConcat (map showCase xs))]
				      where showCase (n, code) = iConcat [iNum n, iStr ": ", iCode code,iNewline]
...
showInstruction (Pushbasic n)     = iConcat [iStr "Pushbasic ", iNum n]
