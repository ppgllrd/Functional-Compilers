...
pAlt    	= do pLiteral tkLT
             	     int <- pInteger    ++ fatalError "Integer for tag expected"  
             	     pMustBe tkGT
...
pExpr7          =    do var <- pVar
	          ...
	          ++ do char <- pCharacter
                  ...
                  ++ do pLiteral tkPack
                        pLiteral tkOCB
                        n1 <- pInteger   ++ fatalError "Pack definition: Integer for tag expected"
                        pMustBe tkComma
                        n2 <- pInteger   ++ fatalError "Pack definition: Integer for arity expected"
                        pMustBe tkCCB
